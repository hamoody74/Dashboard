                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control form-control-xl" id="full-name"
                                                    name="FullName" value="{{ $trainer->FullName }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control form-control-xl" id="mobile"
                                                    name="mobile_number" value="{{ $trainer->mobile_number }}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <select class="form-select form-control-xl" id="gender" name="Gender">
                                                    <option value="{{ $trainer->Gender }}" selected>
                                                        {{ $trainer->Gender }}==>[Selected]</option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="date" class="form-control form-control-xl" id="stwoda"
                                                    name="start_work_date" value="{{ $trainer->start_work_date }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <textarea class="form-control" id="exerspe" name="Exercise_specialties">{{ $trainer->Exercise_specialties }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <textarea class="form-control" id="certifcates" name="certifcates">{{ $trainer->certifcates }}</textarea>
                                            </div>
                                        </div>
                                    </div>
