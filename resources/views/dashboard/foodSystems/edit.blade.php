        ...
        <div class="components-preview wide-md mx-auto">
            <div class="nk-block-head nk-block-head-lg wide-sm">
                <div class="nk-block-head-content">
                    ...
                    <h2 class="nk-block-title fw-normal">EditFood System</h2>
                </div>
            </div><!-- .nk-block-head -->
            <div class="nk-block nk-block-lg">
                <div class="card card-bordered card-preview">
                    <div class="card-inner">
                        <form method="POST" action="{{ route('foodSystems.update', $foodSystem->id) }}">
                            @method('PUT')
                            @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control form-control-xl" id="fs-name"
                                                    name="food_system_name" value="{{ $foodSystem->food_system_name }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="number" class="form-control form-control-xl" id="fs-ca"
                                                    name="total_day_calories" value="{{ $foodSystem->total_day_calories }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="number" class="form-control form-control-xl" id="fs-mn"
                                                    name="meals_number" value="{{ $foodSystem->meals_number }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control form-control-xl" id="fs-we"
                                                    name="for_over_weight" value="{{ $foodSystem->for_over_weight }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <textarea class="form-control" id="fs-cont" name="food_system_content">{{ $foodSystem->food_system_content }}</textarea>
                                            </div>
                                        </div>
                                    </div>
